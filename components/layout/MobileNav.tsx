  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden p-2 text-azul-profundo"
      >
      ...
      {open && (
        <div
          className="fixed inset-0 bg-azul-profundo/40 backdrop-blur-sm z-40"
      ...
      >
        <button
          ...
          className="self-end p-1 text-azul-profundo"
        >
            ...
            {nav.map((item) => (
              <li key={item.href}>
                <Link
                  href={item.href}
                  onClick={() => setOpen(false)}
                  className="block py-2.5 text-base font-sans font-medium text-azul-profundo
                             hover:text-dorado transition-colors"
                >
                  {item.label}
                </Link>
              </li>
