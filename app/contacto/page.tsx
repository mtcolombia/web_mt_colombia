...
export default function ContactoPage() {
  return (
    <>
      ...
      <section className="section-y bg-beige border-t border-azul-profundo/[0.04]">
        <div className="container-site prose-width">
          <details className="group">
            <summary className="list-none [&::-webkit-details-marker]:hidden flex items-center justify-between cursor-pointer focus:outline-none select-none">
              <h2 className="text-3xl md:text-4xl mb-0">Política de Privacidad</h2>
              <span className="text-azul-profundo/50 group-open:rotate-180 transition-transform duration-200">
